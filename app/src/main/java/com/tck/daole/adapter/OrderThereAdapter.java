...
public class OrderThereAdapter extends RecyclerView.Adapter<OrderThereAdapter.MyViewHolder> {
    private List<OrderList.Shop> shop_list;
    private Context context;

    public OrderThereAdapter(List<OrderList.Shop> shop_list, Context context) {
