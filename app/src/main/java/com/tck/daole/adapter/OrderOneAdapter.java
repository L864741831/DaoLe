...
public class OrderOneAdapter extends RecyclerView.Adapter<OrderOneAdapter.MyViewHolder> {
    private List<OrderList.Shop> shop_list;
    private Context context;

    public OrderOneAdapter(List<OrderList.Shop> shop_list, Context context) {
