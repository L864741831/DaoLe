...
public class ShopcartAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (group.isEdtor()) {
             ...
             *
             */
            gholder.tvStoreEdtor.setVisibility(View.GONE);
        }
...
//            }
        ...
        if (goodsInfo != null) {
            ...
            cholder.tvIntro.setText(goodsInfo.getDesc());   //设置商品名称

            cholder.tvPrice.setText("￥" + goodsInfo.getPrice() + "");   //设置商品价格
            cholder.etNum.setText(goodsInfo.getCount() + "");   //设置商品销量
            ...
            ImageLoader.getInstance().displayImage(UriUtil.ip+goodsInfo.getColor(), cholder.ivAdapterListPic, options);

            cholder.tv_beizhu.setText(goodsInfo.getSize()); //设置商品详情备注

            cholder.ll_shop_cat_shangpin.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    Log.i("进入商品详情",goodsInfo.getName());
/*                    Intent intent = new
                            Intent(context,MerchandiseActivity.class);
                    //在Intent对象当中添加一个键值对
                    intent.putExtra("takeProjectId",goodsInfo.getName());
                    context.startActivity(intent);*/
                }
            });

            //cholder.ivAdapterListPic.setImageResource(goodsInfo.getGoodsImg());   //设置头像
            //cholder.tvColorsize.setText("颜色：" + goodsInfo.getColor() + "," + "尺码：" + goodsInfo.getSize() + "瓶/斤");  //设置颜色和尺码
...
//            });
    ...
    static class ChildViewHolder {
        ...
        @BindView(R.id.stub)
        ViewStub stub;
        @BindView(R.id.ll_shop_cat_shangpin)
        LinearLayout ll_shop_cat_shangpin;
