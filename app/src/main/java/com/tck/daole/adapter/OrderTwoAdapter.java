...
public class OrderTwoAdapter extends RecyclerView.Adapter<OrderTwoAdapter.MyViewHolder> {
    private List<OrderList.Shop> shop_list;
    private Context context;

    public OrderTwoAdapter(List<OrderList.Shop> shop_list, Context context) {
