...
public class SystemMsgAdapter extends RecyclerView.Adapter<SystemMsgAdapter.MyViewHolder> {
    private List<Map<String, Object>> list;
    private Context context;

    public SystemMsgAdapter(List<Map<String, Object>> list, Context context) {
        this.list = list;
