 ...
 * 订单待付款fragment
 */
public class DingDanTwoFragment extends BaseFragment {
...
//    }
    ...
    protected void initListener() {
        adapter.setOnItemClickListener(new OrderAdapter.OnItemClickListener() {
            ...
            public void onJuJueClick(final int position) {
                    ...
                    case 2:
                        if (type==5) {
                            ...
                            dialogUtils.setOnTwoBtnClickListener(new DialogUtils.OnTwoBtnClickListener() {
                                ...
                                public void onClick() {
                                    dialogUtils.hide();
                                    orderUtil.cancelOrder(shop_list.get(position).orderId,DingDanTwoFragment.this,position);
                                }
                            });
                            dialogUtils.show();
                ...
                DingDanTwoFragment.this.position=position;
            }
                ...
                switch (state) {
                    case 3:
                        ...
                        dialogUtils.setOnTwoBtnClickListener(new DialogUtils.OnTwoBtnClickListener() {
                            ...
                            public void onClick() {
                                dialogUtils.hide();
                                orderUtil.confirmOrder(shop_list.get(position).orderId, DingDanTwoFragment.this,position);
                            }
                        });
                        dialogUtils.show();
                        break;
    ...
    public void getListData() {
        if (App.islogin) {
            getOrder(App.token, index+"", index2+"", "2");
        } else {
...
//        shop_list.get().orderState=orderState;
        shop_list.remove(DingDanTwoFragment.this.position);
        ...
        if (NetUtil.isNetWorking(activity)) {
            ...
            ThreadPoolManager.getInstance().getNetThreadPool().execute(new Runnable() {
                ...
                public void run() {
                    ...
                    httpInterface.getOrderList23(token, index, num, new MApiResultCallback() {
                        @Override
