...
import com.tck.daole.fragment.CommodityFragment;
import com.tck.daole.fragment.ShopFragment;
...
public class MyCollectionActivity extends FragmentActivity {
    ...
    private void InitTextView(){
        ...
        ll_back.setOnClickListener(new MyOnClickListener(3));
    ...
    private void InitViewPager() {
        ...
        pictureTextView.setTextColor(getResources().getColor(R.color.orange));
    ...
    private void InitFragment(){
        ...
        fragmentArrayList.add(new ShopFragment());
        fragmentArrayList.add(new CommodityFragment());
            ...
            switch (position){
                ...
                case 1:
                    ...
                    if (currIndex == 0) {
                        ...
                        resetTextViewTextColor();
                        movieTextView.setTextColor(getResources().getColor(R.color.orange));
    ...
    private void resetTextViewTextColor(){
        ...
        pictureTextView.setTextColor(getResources().getColor(R.color.nomalText));
        movieTextView.setTextColor(getResources().getColor(R.color.nomalText));
    }
