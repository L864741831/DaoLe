...
public class ModifyPasswordActivity extends BaseActivity {
    ...
    protected void initData() {
        phone = SPUtil.getData(ModifyPasswordActivity.this,"phone","").toString();
    }
                ...
                public void run() {
                    ...
                    httpInterface.updatePassword(inputYzm,phone,password, new MApiResultCallback() {
                        ...
                        public void onSuccess(String result) {
                            ...
                            //toast(YanZhengMa+"\n"+message);
                            MyCountDownTimer timer = new MyCountDownTimer(ModifyPasswordActivity.this, forget_yanzheng, 60000, 1000);
                            timer.start();
